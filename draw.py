...
def main():
    ...
    # ax.set_title('Accuracy vs. Epsilon under best parameters')
    plt.xlabel('Epsilon', fontsize=20)
    plt.ylabel('Accuracy (%)', fontsize=20)
    plt.grid(True)
    # lgd = plt.legend(loc='lower right', borderaxespad=0.5, fancybox=True, shadow=True)
    ...
    # print("Wrote figure to {0}".format(fig_name))
